...
from account.serializers import ProfileSerializers, SendPasswordResetEmailSerializer, UserChangePasswordSerializers, UserRegistrationSerializers, UserLogInSerializers, UserRestPinSerializer
...
class UserRegistrationView(APIView):
    ...
    def post(self, request, format=None):
        ...
        # send_activation_email(Myuser.email, activation_url)
            return Response({'token':token, 'msg':'Registration Successful. Please Login.'}, status = status.HTTP_201_CREATED)    
...
class UserLogInView(APIView):
    ...
    def post(self, request, format=None):
        ...
        return Response({'msg':"SignIn Failed"}, serializer.errors, status=status.HTTP_400_BAD_REQUEST)
